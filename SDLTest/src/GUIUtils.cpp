...
void GUIUtils::setGUITopMiddle(AGameObject * pObject, Vector2D offset)
{
...
void GUIUtils::setGUIMidMiddle(AGameObject * pObject, Vector2D offset)
{
...
void GUIUtils::setGUIBotMiddle(AGameObject * pObject, Vector2D offset)
{
