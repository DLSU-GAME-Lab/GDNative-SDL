...
//
//	Text* pLine1 = new Text("Page1_Line1", "Ang SWBST ay isang paraan upang madaling matukoy ang mahahalagang bahagi ng \n kuwento at matulungan kang buod ng kuwento.", Vector2D(-60, 300), Vector2D(.75, .75), 0.f, false);
