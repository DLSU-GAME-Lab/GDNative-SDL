...
void ObjectiveIntro::initialize()
{
	...
	TextRenderer* pTabletTextR1 = (TextRenderer*)pTabletText1->findComponentByName("TextRenderer");
	...
	TextRenderer* pCloseTextR1 = (TextRenderer*)pCloseText->findComponentByName("TextRenderer");
